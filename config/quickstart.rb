...
upload2=Cloudinary::Uploader.upload("../app/assets/images/backdriver-logo-car.svg", 
  use_filename:true, 
  unique_filename:false,
  overwrite:true
)
...
# Manually set the asset's public ID + allow overwriting asset with new versions.
  ...
  upload3=Cloudinary::Uploader.upload("https://cloudinary-devs.github.io/cld-docs-assets/assets/images/coffee_cup.jpg", 
      public_id: "coffee", 
      unique_filename: false,
      overwrite: true
      )
